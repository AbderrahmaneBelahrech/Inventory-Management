...
<!-- // produit_id -->
                        ...
                        <form action="{{route('commandeprod.store')}}" id="basic-form" method="post" novalidate>
                            @csrf
                            @method('')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="quantiteCom"  id="example-text-input">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Commende</label>
                                    <select class="selectpicker" name="commande_id"  required>
                                    <option value="a"  selected>choisire le numero de la commende</option>
                                    <!-- @foreach($p as $k) -->
