                ...
                <div class="card m-b-30">
                    ...
                    <head>
                            <div class="card-header" style="display: flex;justify-content: space-between;margine-bottom: 100px;">
                                <h4 class="mt-0 header-title">Liste des fournisseurs</h4>

                                <div style="margine-bottom: 10px;lefte: 200px;" class="row">
                                    <div class="col-lg-12" style="margine-left ">
                                        <a class="btn btn-success" style="margine-bottom: 10px;lefte: 200px; "href="{{ route('fornisseur.create') }}">
                                            ajouter
                                        </a>
                                    </div>
                                </div> 
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a href="{{ route('fornisseur.edit',['fornisseur' => $p->id]) }}" class="btn btn-info btn-sm m-1 mt-0" title="Edit"><i class="fa fa-edit"></i></a>
                                    <form  action="{{ route('fornisseur.destroy',['fornisseur' => $p->id]) }}" method="post">
                                        @csrf
                                        @method('DELETE')
