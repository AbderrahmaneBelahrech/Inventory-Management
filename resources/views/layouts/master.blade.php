    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{route('produit.index')}}" class="waves-effect">
                                    ...
                                    <span> Produit <span class="badge badge-success badge-pill float-right"></span></span>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('categorie.index')}}" class="waves-effect">
                                    <i class="dripicons-briefcase"></i>
                                    <span> Categorie <span class="badge badge-success badge-pill float-right"></span></span>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('commande.index')}}" class="waves-effect">
                                    <i class="dripicons-document"></i>
                                    <span> Commande <span class="badge badge-success badge-pill float-right"></span></span>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('approvisionnement.index')}}" class="waves-effect">
                                    <i class="dripicons-document"></i>
                                    <span> Approvisionnement <span class="badge badge-success badge-pill float-right"></span></span>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('client.index')}}" class="waves-effect">
                                    <i class="dripicons-user"></i>
                                    <span> Client <span class="badge badge-success badge-pill float-right"></span></span>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('fornisseur.index')}}" class="waves-effect">
                                    <i class="dripicons-user"></i>
                                    <span> Fornisseur <span class="badge badge-success badge-pill float-right"></span></span>
                                </a>
                            </li>
            ...
            <div class="content-page">
                    ...
                    <div class="topbar">
                        ...
                        <div class="topbar-left	d-none d-lg-block">
                            <div class="text-center">
                                ...
                                <a href="index.html" class="logo">Wykee_Solution</a>
                        ...
                        <nav class="navbar-custom">
                            ...
                            <ul class="list-inline float-right mb-0">
                                ...
                                <li class="list-inline-item dropdown notification-list nav-user">
                                    ...
                                    aria-haspopup="false" aria-expanded="false">
                                        <img src="/assets/images/users/avatar-6.jpg" alt="user" class="rounded-circle">
                                        <span class="d-none d-md-inline-block ml-1"> Wykee solution <i class="mdi mdi-chevron-down"></i> </span>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown">
                                        ...
                                        <a class="dropdown-item" href="#"><i class="dripicons-exit text-muted"></i> deconnection</a>
                                    </div>
                                </li>
                            ...
                            <ul class="list-inline menu-left mb-0">
                                ...
                                <li class="list-inline-item dropdown notification-list d-none d-sm-inline-block">
                                    <a class="nav-link dropdown-toggle arrow-none waves-effect" data-toggle="dropdown" href="#" role="button"
                                    aria-haspopup="false" aria-expanded="false">
                                        Voir plus <i class="mdi mdi-plus"></i>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-animated">
                                        <a class="dropdown-item" href="{{route('produit.index')}}">Produit</a>
                                        <a class="dropdown-item" href="{{route('categorie.index')}}">Categorie</a>
                                        <a class="dropdown-item" href="{{route('fornisseur.index')}}">Forniseur</a>
                                        <a class="dropdown-item" href="{{route('client.index')}}">Client</a>
                                    </div>
                                </li>
                                <li class="list-inline-item notification-list d-none d-sm-inline-block">
                                    <a href="{{route('approvisionnement.index')}}" class="nav-link waves-effect">
                                        Approvisionnement
                                    </a>
                                </li>
                                <li class="list-inline-item notification-list d-none d-sm-inline-block">
                                    <a href="{{route('commande.index')}}" class="nav-link waves-effect">
                                    Commande
                                    </a>
                                </li>
                ...
                <footer class="footer">
                    © 2022 - 2023 EMSI <span class="d-none d-md-inline-block"> - Wykee Solution <i class="mdi mdi-heart text-danger"></i> by Belahrech Abderrahmane.</span>
                </footer>
